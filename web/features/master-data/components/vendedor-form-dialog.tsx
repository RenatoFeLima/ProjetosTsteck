...
export function VendedorFormDialog({ open, mode, item, onClose, onSave }: Props) {
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-zinc-900/60 p-4 backdrop-blur-sm"
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          <Field label="Nome *">
            <input ref={nameRef} required value={name} onChange={e => setName(e.target.value)} placeholder="Ex: João Silva" className={inputCls} />
          </Field>
